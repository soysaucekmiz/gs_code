  ...
  <div class="jumbotron">
   <fieldset>
    <legend>ユーザー登録</legend>
     ...
     <label>管理者フラグ：<br>
        <input type="radio" name="kanri_flg", value="0" <?php if($row["kanri_flg"]==0){echo "checked";}?>>一般ユーザー
        <input type="radio" name="kanri_flg", value="1" <?php if($row["kanri_flg"]==1){echo "checked";}?>>管理者
     </label><br>
     <label>利用フラグ：<br>
